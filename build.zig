...
const progs = [_]Prog{
    ...
    .{ .run_name = "03.0", .name = "textures-blend", .root = "src/03.0_textures.zig" },
    .{ .run_name = "03.1", .name = "textures-multiple", .root = "src/03.1_textures.zig" },
    .{ .run_name = "04.0", .name = "transforms", .root = "src/04.0_transforms.zig" },
};
